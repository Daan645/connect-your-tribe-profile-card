...
const githubData = await fetchJson('https://api.github.com/users/daan645/repos')
...
app.get('/', function (request, response) {
  ...
  response.render('index', {persoonlijkeData: persoonlijkeData, githubData: githubData})
})
